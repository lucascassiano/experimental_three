  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ['active', 'primary', 'danger', 'link', 'small', 'large', 'secondary', 'text', 'className']);

      var className = (0, _classnames2.default)('uk-button', customClassName, {
      ...
      return React.createElement('button', _extends({}, other, { className: className }));
    }
  }]);
